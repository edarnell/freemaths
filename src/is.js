...
import { change_sign } from './compare'
const maths_keys = {
  '±': '+\\', '–': '-\\', '˽': ' \\', '√': '^\\', 'π': 'p\\', '∫': '[\\', '≈': '~=', '≠': '=\\', '≥': '>=', '≤': '<=', '÷': '/\\', '≡': '==', '…': '...', '⇒': '=>', '⟺': '⇐>',
  '∞': 'i\\', 'α': 'a\\', 'β': 'b\\', 'γ': 'g\\', 'δ': 'd\\', 'Δ': 'D\\', 'ϵ': 'e\\', 'μ': 'm\\', 'λ': 'l\\', 'σ': 's\\', 'Σ': 'S\\', 'θ': 't\\', 'Π': 'P\\',
  '∩': '∪\\', '∪': 'u\\', '×': '*\\', '⋅': '.\\', '°': 'o\\', '∝': '~\\', '∠': '<\\'
  , '→': '6\\', '←': '4\\', '↑': '8\\', '↓': '2\\', '↖': '7\\', '↗': '9\\', '↙': '1\\', '↘': '3\\', '⇐': '=<', '﹎': '_\\',
  'φ': 'f\\', 'Φ': 'F\\', '⬤': '\\@', '✓': 'y\\', '✗': 'x\\', 'ξ': 'E\\', '∈': '{\\', 'ℤ': 'Z\\', 'ℝ': 'R\\', 'ℕ': 'N\\', 'ℚ': 'Q\\'
  , '(-b±√(b^2-4ac))/(2a)': 'q\\', '⭮': 'c\\', '⭯': 'C\\', '◯': 'O\\', '⊥': '|\\'
}
//const _greek={'α':'\\aplha','β':'\\beta','γ':'\\gamma','δ':'\\delta','ϵ':'\\epsilon','μ':'\\mu','π':'\\pi','σ':'\\sigma','θ':'\\theta','Σ':'\\Sigma','…':'...'}
const _greek = {
  'du': 'du', 'dy': 'dy', 'dx': 'dx', 'α': 'α', 'β': 'β', 'γ': 'γ', 'δ': 'δ', 'ϵ': 'ϵ', 'μ': 'μ', 'λ': 'λ', 'π': 'π', 'Σ': 'Σ', 'σ': 'σ', 'θ': 'θ', '…': '…', '°': '°', 'Δ': 'Δ', '%': '\\%', '∠': '∠', '∞': '∞', 'φ': 'φ', 'Φ': 'Φ'
  , 'ξ': 'ξ', '⬤': '⬤', '✓': '✓', '£': '£', '?': '?', '⭯': '\\circlearrowleft ', '⭮': '\\circlearrowright', 'ℤ': 'ℤ', 'ℝ': 'ℝ', 'ℕ': 'ℕ', 'ℚ': 'ℚ'
}
...
function is_tree(a) {
  return (a && typeof a === 'object' && a.op !== undefined)
}
