...
import { expression, precedence } from './expression.js'
import { is_string, tree, is_tree, is_numeric, is_negative, is_minus1, is_integer, is_mixed, is_decimal } from './is.js'
import { evaluate, var_error, convert, is_n_f_b, simplest, stof } from './evaluate.js'
...
function compare_dpsf(a, b, dpsf) {
	...
	_a = convert(a)
	_b = convert(b)
	if (!is_numeric(_a) || !is_numeric(_b) || _a === _b) ret = _a === _b
	else {
